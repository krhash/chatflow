...
public class Constants {
    ...
    public static final int WARMUP_RESPONSE_TIMEOUT_SECONDS = 10;
    ...
    public static final int MESSAGE_TIMEOUT_MILLIS = 60_000; // 120 seconds timeout for message response
    public static final int PROGRESS_REPORT_INTERVAL = 10000;
    public static final int MAIN_PHASE_RESPONSE_TIMEOUT_MINUTES = 3;
}
